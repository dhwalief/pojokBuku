        ...
        <nav class="bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700 sticky top-0 z-50" x-data="{ mobileMenuOpen: false }">
                ...
                <div class="flex justify-between h-16">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden space-x-8 sm:ml-10 sm:flex">
                            <a href="{{ route('index') }}"
                                class="text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 px-3 py-2 rounded-md text-sm font-medium transition-colors {{ request()->routeIs('index') ? 'text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-gray-700' : '' }}">
                                Beranda
                            </a>
                            ...
                            @else
                            <a href="{{ route('borrows.index') }}"
                                class="text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 px-3 py-2 rounded-md text-sm font-medium transition-colors {{ request()->routeIs('borrows.create') ? 'text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-gray-700' : '' }}">
                                Pinjam Buku
                            </a>
                            @endif
                            @endauth
            ...
            <div x-show="mobileMenuOpen" class="sm:hidden border-t border-gray-200 dark:border-gray-700">
                <div class="px-2 pt-2 pb-3 space-y-1">
                    <a href="{{ route('index') }}" class="block px-3 py-2 rounded-md text-base font-medium text-gray-900 dark:text-white hover:text-blue-600 hover:bg-gray-50 dark:hover:bg-gray-700">Beranda</a>
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div class="col-span-1 md:col-span-2">
                        <div class="flex items-center mb-4">
                            <div class="text-2xl mr-2">📚</div>
                            <span class="text-xl font-bold">pojokBuku</span>
                        </div>
                        ...
                        <div class="flex space-x-4">
                            <a href="https://www.instagram.com/dhwalief/" class="text-gray-300 hover:text-white transition-colors">
                                <svg class="h-6 w-6" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
                    ...
                    <div>
                        ...
                        <ul class="space-y-2">
                            <li><a href="{{ route('index') }}" class="text-gray-300 hover:text-white transition-colors">Beranda</a></li>
