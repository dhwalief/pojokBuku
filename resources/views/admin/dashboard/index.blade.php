...
<div class="py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-semibold text-gray-900">{{ $totalBooks ?? 0 }}</p>
                        </div>
                    </div>
                    <div class="mt-4">
                ...
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-semibold text-gray-900">{{ $activeBorrows ?? 0 }}</p>
                        </div>
                    </div>
                    <div class="mt-4">
                        <div class="flex items-center text-sm text-gray-600">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            ...
            <div class="bg-white shadow-sm rounded-lg border border-gray-200">
                ...
                <div class="p-6">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="flex-shrink-0">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                            @if($borrow->status === 'Dipinjam') bg-yellow-100 text-yellow-800
                    ...
                    <div class="text-center py-8">
                        ...
                        <p class="text-gray-500 text-sm mt-2">Belum ada peminjaman</p>
                    </div>
                    @endif
                </div>
            </div>
            ...
            <div class="bg-white shadow-sm rounded-lg border border-gray-200">
                <div class="px-6 py-4 border-b border-gray-200">
                    <h3 class="text-lg font-medium text-gray-900">Buku Terbaru</h3>
                </div>
                <div class="p-6">
                    ...
                    <div class="text-center py-8">
                        ...
                        <p class="text-gray-500 text-sm mt-2">Belum ada buku</p>
                    </div>
                    @endif
                </div>
            </div>
